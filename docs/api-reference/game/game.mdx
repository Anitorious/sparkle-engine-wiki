...
The game settings provided during initialization. Contains window configuration, graphics backend selection, and timing parameters. (see [`GameSettings`](/docs/api-reference/game/game-settings))
