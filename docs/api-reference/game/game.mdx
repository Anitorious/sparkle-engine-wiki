...
The game settings provided during initialization. Contains window configuration, graphics backend selection, and timing parameters. (see [`GameSettings`](/api-reference/game/game-settings.md))
